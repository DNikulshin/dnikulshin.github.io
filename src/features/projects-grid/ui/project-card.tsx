...
export function ProjectCard({ repo }: ProjectCardProps) {
  return (
    <Card className="group hover:shadow-2xl transition-all duration-300 border border-white/10 bg-white/5 backdrop-blur-sm hover:border-blue-500/50 hover:-translate-y-1">
      <CardHeader>
